        ...
        <div className='relative flex items-center justify-center mx-3 sm:shadow sm:shadow-md min-h-sm md:pt-0 md:bg-blue-300 sm:mt-6 md:mt-0 lg:py-10'>
            ...
            <div className='absolute my-auto md:w-1/2 md:static'>
                <main className='flex flex-col items-end justify-center pt-2 pr-5 md:pr-0 lg:pr-9 xl:pr-10 lg:pt-8 xl:pt-16 text-white-primary'>
                    <h1 className='pb-4 text-2xl text-right xl:pb-10 md:text-3xl lg:text-4xl xl:text-5xl font-heading md:text-black-heading'>Pristine surroundings,<br/>effortlessly</h1>
                    <p className='max-w-xl pb-6 text-sm text-right md:text-sm md:leading-4 lg:text-lg lg:leading-5 md:max-w-4xl md:text-black-BoBody'>Our service let’s you enjoy an immaculate home, whilst you save on time and effort. We put a sparkling house a phone call away.</p>
                    <Link href='/book'>
